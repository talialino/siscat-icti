...
$mensagens = [
    ...
    13 => "foi submetido para avaliação por um técnico-administrativo e necessita ser distribuído para um núcleo acadêmico avaliar.",
];
...
<div style="font-family: arial">
    ...
    <hr />   
    <p><?='O seguinte relatório de projeto '.$mensagens[$relatorio->situacao]?></p>
    <?= DetailView::widget([
        'model' => $relatorio,
        ...
        'attributes' => [
            'titulo:ntext',
            'tipoProjeto',
            ['attribute' => 'id_pessoa', 'value' => $relatorio->pessoa->nome],
        ]
    ]);?>
