...
namespace app\templatesGii\crud;
...
class Generator extends \yii\gii\Generator
{
    ...
    {
        return 'Gerador do CRUD com as opções de tradução dos campos e mensagens tanto de views quanto do controlador.';
    }
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['modelClass','module', 'controllerClass', 'baseControllerClass', 'indexWidgetType'], 'required'],
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            ...
            'module' => 'The module to appear in the bread crumbs',
