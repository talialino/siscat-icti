...
class Module extends BaseModule
{
    ...
    /**
     * Construtor que busca no banco de dados todos os usuários que tem permissão de Administrador do SISCAT e define como administradores para os módulos user e rbac
     */
    public function __construct($id, $parent = null, $config = [] )
    {
        ...
        $query->select('username')->from(['u' => 'user','a' => 'auth_assignment'])->where('item_name = "siscatAdmin" AND a.user_id = u.id');
        $result = $query->all();
        foreach($result as $key => $value)
            $this->admins[] = $value['username'];
    }
    /**
     * @return string
     */
