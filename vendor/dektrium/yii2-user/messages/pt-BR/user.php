...
return array (
  '#' => '',
  'Are you sure you want to switch to this user for the rest of this Session?' => 'Você tem certeza que deseja mudar para este usuário pelo resto desta sessão?',
  'Are you sure?' => 'Você tem certeza?',
  'Are you sure? There is no going back' => 'Are you sure? Não há como retornar',
  'Become this user' => 'Ser como este usuário',
  'Delete account' => 'Deletar conta',
  'Error while trying to generate new password' => 'Erro ao tentar gerar nova senha',
  'Generate and send new password to user' => 'Gerando e enviando senha para usuário',
  'Impersonate user is disabled in the application configuration' => 'Usuário representado está desabilitado na configuração da aplicação',
  'It will be deleted forever' => 'Isto será deletado para sempre',
  'Last login' => 'Último login',
  'Never' => 'Nunca',
  'New Password has been generated and sent to user' => 'Nova senha foi gerada e enviada para o usuário',
  'New rule' => 'Nova regra',
  'Not found' => 'Não encontrado',
  'Once you delete your account, there is no going back' => 'Uma vez deletada a conta, não há como voltar atrás',
  'Password generation is not possible for admin users' => 'Geração de senha não é permitida para usuários administradores',
  'Password is not necessary because the module is in DEBUG mode.' => 'Senha não necessária porque o módulo está em modo DEBUG',
  'Please be certain' => 'Por favor, esteja certo',
  'Registration on this website is disabled' => 'Registro neste site está desabilitado',
  'Rules' => 'Regras',
  'Time zone' => 'Fuso horário',
  'Time zone is not valid' => 'Fuso horário não válido',
  'We have generated a password for you' => 'Nós geramos uma senha para você',
  'Your account has been completely deleted' => 'Sua conta foi totalmente delatada',
  'Your account on {0} has a new password' => 'Sua conta {0} tem uma nova senha',
  'Your password on {0} has been changed' => 'Sua senha {0} foi alterada',
  ...
  'Invalid login' => 'Usuário não cadastrado',
