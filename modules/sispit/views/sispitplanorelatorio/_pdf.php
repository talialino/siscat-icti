...
<div style="border-bottom:1px solid #CCC; margin-bottom:50px">
    <ul style="padding-top:10px;padding-bottom:0; text-align:left; list-style-type:none; font-size: 14px; margin-left:0;padding-left:0">
        <li><strong>Nome: </strong><?=$model->pessoa->nome?></li>
        <li><strong>Matrícula siape: </strong><?=$model->pessoa->siape?></li>
        <li><strong>Regime de trabalho: </strong><?=$model->pessoa->jornada?></li>
    </ul>
</div>
<div class="infoPit">
<?
...
echo DetailView::widget([
    ...
    'attributes' => [
        [
            'columns' => [
                ['attribute' => $pit_rit ? 'ch_graduacao_sem1_rit' : 'ch_graduacao_sem1_pit', 'valueColOptions'=>['style'=>'width:10%;border:0'], 'label' => $suplementar ? 'CH Graduação' : null],
                ['attribute' => $pit_rit ? 'ch_pos_sem1_rit' : 'ch_pos_sem1_pit', 'valueColOptions'=>['style'=>'width:10%;border:0'], 'label' => $suplementar ? 'CH Graduação' : null],

                ['attribute' => $pit_rit ? 'ch_graduacao_sem2_rit' : 'ch_graduacao_sem2_pit', 'visible' => !$suplementar, 'valueColOptions'=>['style'=>'width:10%;border:0'],],
                ['attribute' => $pit_rit ? 'ch_pos_sem2_rit' : 'ch_pos_sem2_pit', 'visible' => !$suplementar, 'valueColOptions'=>['style'=>'width:10%;border:0'],],
            ]
        ],
    ]
]);
