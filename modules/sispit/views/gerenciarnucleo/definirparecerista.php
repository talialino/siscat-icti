...
$docentes = ArrayHelper::map(SisrhPessoa::find()->innerJoinWith('sisrhSetorPessoas')->where(['situacao' => 1, 'id_cargo' => 1, 'id_setor' => Yii::$app->session->get('siscat_nucleo')])->orderby('nome')->all(),'id_pessoa','nome');
