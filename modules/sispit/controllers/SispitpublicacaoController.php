...
/**
 * SispitpublicacaoController implements the CRUD actions for SispitPublicacao model.
 */
class SispitpublicacaoController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * Lists all SispitPublicacao models.
     * @return mixed
     */
    public function actionIndex($id)
    {
        ...
        $searchModel = new SispitPublicacaoSearch();
    ...
    /**
     * Displays a single SispitPublicacao model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Creates a new SispitPublicacao model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate($id)
    {
        $model = new SispitPublicacao();
        ...
        if ($model->load(Yii::$app->request->post())){
            ...
            if($model->save())
                return $this->redirect(['sispitpublicacao/index', 'id' => $model->id_plano_relatorio]);
        }
    ...
    /**
     * Updates an existing SispitPublicacao model.
    ...
    {
        $model = $plano ? new SispitPublicacao() : $this->findModel($id);
    ...
    /**
     * Deletes an existing SispitPublicacao model.
    ...
    /**
     * Finds the SispitPublicacao model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return SispitPublicacao the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = SispitPublicacao::findOne($id)) !== null) {
            return $model;
        }
