...
/**
 * SispitmonitoriaController implements the CRUD actions for SispitMonitoria model.
 */
class SispitmonitoriaController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * Lists all SispitMonitoria models.
     * @return mixed
     */


    /**
     * Displays a single SispitMonitoria model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Creates a new SispitMonitoria model..
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate($id)
    {
        $model = new SispitMonitoria();
    ...
    /**
     * Updates an existing SispitMonitoria model.
    ...
    {
        $model = $plano ? new SispitMonitoria() : $this->findModel($id);
    ...
    /**
     * Deletes an existing SispitMonitoria model.
    ...
    /**
     * Finds the SispitMonitoria model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return SispitMonitoria the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = SispitMonitoria::findOne($id)) !== null) {
            return $model;
        }
