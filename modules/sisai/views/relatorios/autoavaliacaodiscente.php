...
$this->title = 'Relatórios de Autoavaliação Discente';
...
<div class="sisai-relatorios-discente row">
    ...
    <h1 class="cabecalho"><?= Html::encode($this->title) ?></h1>
        ...
        <?= $this->render('_searchavaliacaodiscente', ['model' => $model])?>

        <?php if($relatorio):?>

            <div class="bodyRelatorio">

                <?= $this->render('_tabelaavaliacaopadrao', ['titulo' => "Autoavaliação Discente $model->semestre - $model->colegiado",
                    'relatorio' => $relatorio])?>
